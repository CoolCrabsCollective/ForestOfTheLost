...
class Player : public Entity, public Alive<int>, public Solid, public Anime {
	...
	sf::Sound interactSound, noInteractSound, collisionSound, walkSound, heartBeatSound, slowHeartBeatSound, fastHeartBeatSound, fasterHeartBeatSound;

    float heartBeatDelay = 1000.0f;

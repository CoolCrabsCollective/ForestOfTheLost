...
namespace GameAssets {
	...
	ASSET(wiz::SoundAsset, SLOW_HEART_BEAT_SOUND, ("sfx/slow_heart_beat.ogg"))
	ASSET(wiz::SoundAsset, FAST_HEART_BEAT_SOUND, ("sfx/fast_heart_beat.ogg"))
	ASSET(wiz::SoundAsset, FASTER_HEART_BEAT_SOUND, ("sfx/faster_heart_beat.ogg"))
